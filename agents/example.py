...
class Example(BaseAgent):
    ...
    # the game reset 
    def reset(self, obv):
        # Reste the current state and other variables.
    ...
    # Request the agent to decide abouth the action
    ...
    def observe(self, obv, reward, done, action):
        ...
        # self.q_table[self.state_0 + (action,)] : It referes to the specific action on a state. 
